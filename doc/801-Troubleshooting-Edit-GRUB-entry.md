...
Normally this is a blue screen
...
press the key ‘e’. This will allow to change the “default”. You can press “Esc” or “Escape” to return to the menu.
Press or hold SHIFT to go to the menu.
In the menu, you can select a different “entry”, using the Up and Down arrow keys. There may be troubleshooting entries, or ones to use different kernels. After booting, you can verify which kernel was used in Dom0 terminal, by typing uname -a.
...
Each item can be quite long, and may be split over several lines.
Find the item that begins like this: module2  vmlinuz. Use the Up/Down arrow keys to go to it.
...
To remove a parameter, Go left in the line, to the end of it, and use “Backspace” key to remove it.
When you have finished, Press the F10 key, to continue the boot, using your changes. Remember that the changes are temporary. They will not be there next time you restart.

If you make a mistake, “Escape” cancels all changes and returns to the grub menu, where you can press e and try again.
